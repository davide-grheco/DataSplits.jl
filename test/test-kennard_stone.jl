@testitem "LazyKennardStone (CADEX)" begin
  ...
  tr2, te2 = DataSplits.split(Xv, LazyKennardStoneSplit(0.3, CosineDist()); rng=Random.GLOBAL_RNG)
  ...
  @test_throws ArgumentError DataSplits.split(rand(5, 5), LazyKennardStoneSplit(1.0, Euclidean()))
